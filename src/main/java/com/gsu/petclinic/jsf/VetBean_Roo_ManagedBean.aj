...
privileged aspect VetBean_Roo_ManagedBean {
    
    declare @type: VetBean: @ManagedBean(name = "vetBean");
    
    declare @type: VetBean: @SessionScoped;
    
    private String VetBean.name = "Vets";
    
    private Vet VetBean.vet;
    
    private List<Vet> VetBean.allVets;
    
    private boolean VetBean.dataVisible = false;
    
    private List<String> VetBean.columns;
    
    private HtmlPanelGrid VetBean.createPanelGrid;
    
    private HtmlPanelGrid VetBean.editPanelGrid;
    
    private HtmlPanelGrid VetBean.viewPanelGrid;
    
    private boolean VetBean.createDialogVisible = false;
    
    @PostConstruct
    public void VetBean.init() {
    ...
    public String VetBean.getName() {
        return name;
    }
    
    public List<String> VetBean.getColumns() {
        return columns;
    }
    
    public List<Vet> VetBean.getAllVets() {
        return allVets;
    }
    
    public void VetBean.setAllVets(List<Vet> allVets) {
        this.allVets = allVets;
    }
    
    public String VetBean.findAllVets() {
        allVets = Vet.findAllVets();
        dataVisible = !allVets.isEmpty();
        return null;
    }
    
    public boolean VetBean.isDataVisible() {
        return dataVisible;
    }
    
    public void VetBean.setDataVisible(boolean dataVisible) {
        this.dataVisible = dataVisible;
    }
    
    public HtmlPanelGrid VetBean.getCreatePanelGrid() {
    ...
    public void VetBean.setCreatePanelGrid(HtmlPanelGrid createPanelGrid) {
        this.createPanelGrid = createPanelGrid;
    }
    
    public HtmlPanelGrid VetBean.getEditPanelGrid() {
    ...
    public void VetBean.setEditPanelGrid(HtmlPanelGrid editPanelGrid) {
        this.editPanelGrid = editPanelGrid;
    }
    
    public HtmlPanelGrid VetBean.getViewPanelGrid() {
        return populateViewPanel();
    }
    
    public void VetBean.setViewPanelGrid(HtmlPanelGrid viewPanelGrid) {
        this.viewPanelGrid = viewPanelGrid;
    }
    
    public HtmlPanelGrid VetBean.populateCreatePanel() {
    ...
    public HtmlPanelGrid VetBean.populateEditPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
    ...
    public HtmlPanelGrid VetBean.populateViewPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
    ...
    public void VetBean.setVet(Vet vet) {
        this.vet = vet;
    }
    
    public List<Specialty> VetBean.completeSpecialty(String query) {
    ...
    public String VetBean.onEdit() {
        return null;
    }
    
    public boolean VetBean.isCreateDialogVisible() {
        return createDialogVisible;
    }
    
    public void VetBean.setCreateDialogVisible(boolean createDialogVisible) {
        this.createDialogVisible = createDialogVisible;
    }
    
    public String VetBean.displayList() {
        createDialogVisible = false;
        findAllVets();
        return "vet";
    }
    
    public String VetBean.displayCreateDialog() {
        vet = new Vet();
        createDialogVisible = true;
        return "vet";
    }
    
    public String VetBean.persist() {
        String message = "";
        if (vet.getId() != null) {
            vet.merge();
    ...
    public void VetBean.reset() {
        vet = null;
        createDialogVisible = false;
    }
    
    public void VetBean.handleDialogClose(CloseEvent event) {
        reset();
    }
